...
func (z *Reader) init(r io.ReaderAt, size int64) error {
	...
	b := make([]byte, end.directorySize)
	if _, err := r.ReadAt(b, int64(end.directoryOffset)); err != nil {
		return err
	}
	buf := io.NewSectionReader(bytes.NewReader(b), 0, int64(end.directorySize))
